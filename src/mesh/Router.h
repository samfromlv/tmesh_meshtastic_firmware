...
#define FORCE_NEXT_HOP_MY_ONLY_WITH_FALLBACK 1
#define FORCE_NEXT_HOP_MY_AND_OTHERS_WITH_FALLBACK 2
#define FORCE_NEXT_HOP_ALL 3
#define FAVORITE_ROUTER_MODE_HOPS_ONLY 10
#define FAVORITE_ROUTER_MODE_HOPS_AND_RELAY 11
